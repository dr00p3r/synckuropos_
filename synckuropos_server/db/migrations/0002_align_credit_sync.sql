ALTER TABLE "sales" ADD COLUMN IF NOT EXISTS "paymentMethod" text DEFAULT 'cash' NOT NULL;--> statement-breakpoint
ALTER TABLE "debts" ADD COLUMN IF NOT EXISTS "saleId" text;--> statement-breakpoint
...
ON CONFLICT ("debtId") DO NOTHING;--> statement-breakpoint
ALTER TABLE "sales" DROP COLUMN IF EXISTS "isPartOfDebt";--> statement-breakpoint
