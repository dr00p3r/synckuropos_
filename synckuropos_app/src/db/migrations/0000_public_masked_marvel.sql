...
CREATE TABLE `customers` (
	...
	`email` text,
	`address` text,
	`allowCredit` integer DEFAULT false NOT NULL,
...
CREATE TABLE `products` (
	...
	`isTaxable` integer DEFAULT true NOT NULL,
	`allowDecimalQuantity` integer DEFAULT false NOT NULL,
	`_deleted` integer DEFAULT false NOT NULL,
	`createdAt` integer NOT NULL,
	`updatedAt` integer NOT NULL,
	`synced` integer DEFAULT 0 NOT NULL
...
CREATE TABLE `sales` (
	...
	`_deleted` integer DEFAULT false NOT NULL,
	`isPartOfDebt` integer DEFAULT false NOT NULL,
